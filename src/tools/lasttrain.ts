 ...
 * (1タスクで天気・店・終電…と集約するほど、各パターンの描き分け＆ストリーミングが映える)
 */
...
const TABLE: { match: string[]; entry: Entry }[] = [
  ...
  // ── 札幌 (frontend-phpcon-do = 北海道開催) ──
  {
    match: ['すすきの', 'ススキノ', '狸小路'],
    entry: {
      station: 'すすきの駅',
      summary: '市営地下鉄南北線 真駒内方面 0:00頃 / 麻生方面 0:12頃',
      leaveBy: '23:40',
    },
  },
  {
    ...
    entry: {
      station: '大通駅',
      summary: '地下鉄 南北線/東西線/東豊線 各 0:00〜0:24頃 (方面による)',
      leaveBy: '23:45',
    },
  },
  {
    ...
    entry: {
      station: '札幌駅',
      summary: 'JR各線・地下鉄南北線/東豊線 0:00〜0:30前後 (方面により異なる)',
      leaveBy: '23:50',
    },
  },
]
